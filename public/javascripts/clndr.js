            ...
            "<% for(var i = 0; i < numberOfRows; i++){ %>" +
                ...
                "<% var d = j + i * 7; %>" +
                    "<td class='<%= days[d].classes %>'>" +
                        ...
                        "<div class='day-contents'><%= days[d].day %><span ><%= days[d].events.length %></span></div>" +
                    "</td>" +
                "<% } %>" +
                "</tr>" +
            "<% } %>" +
            "</tbody>" +
        "</table>"+ '<div class="event-listing">'+
        ...
        if (!this.options.daysOfTheWeek) {
            ...
            for (var i = 0; i < 7; i++) {
                this.daysOfTheWeek.push(
                    moment().utcOffset(-5).weekday(i).format('dd').charAt(0));
            }
        }
    ...
    Clndr.prototype.render = function () {
        ...
        if (this.options.lengthOfTime.days) {
            ...
            data = {
                ...
                eventsThisMonth : eventThisMonth
            };
        }
        else {
